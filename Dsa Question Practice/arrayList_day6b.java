/*Container With Most Water Using ArrayList
Objective
...
Description
You are given an ArrayList<Integer> where each element represents the height of a vertical line drawn on the x-axis. The distance between consecutive lines is 1 unit. Choose any two lines such that together with the x-axis they form a container that can store the maximum amount of water.
